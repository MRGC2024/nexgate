...
export class MockPixConnector implements PaymentConnector {
  readonly code = 'mock_pix';
  readonly name = 'Mock Pix';
  readonly version = '1.0';
  readonly supportedMethods = ['pix'] as const;
  readonly configSchema = {
    type: 'object',
    properties: {
      apiKey: { type: 'string', description: 'Chave API (mock)' },
    },
  };
  ...
  async createPayment(_config: Record<string, unknown>, payload: CreatePaymentPayload): Promise<CreatePaymentResult> {
    ...
    return {
      ...
      pixQr: `00020126580014br.gov.bcb.pix0136${id}5204000053039865802BR5925NEXGATE MOCK6009SAO PAULO62070503***6304`,
      pixCopyPaste: `00020126580014br.gov.bcb.pix0136${id}5204000053039865802BR5925NEXGATE MOCK6009SAO PAULO62070503***6304`,
      expiresAt,
      raw: { mock: true, id },
    };
  }
